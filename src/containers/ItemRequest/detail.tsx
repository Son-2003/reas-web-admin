...
export const ItemRequestDetail = () => {
  ...
  const handleReview = async (statusItem: 'AVAILABLE' | 'REJECTED') => {
    ...
    try {
      ...
      alert(`Item request has been ${statusItem === 'AVAILABLE' ? 'approved' : 'rejected'} successfully!`);
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mt-4 flex space-x-4">
        <Button onClick={() => handleReview('AVAILABLE')} variant="default">Approve</Button>
        <Button onClick={() => handleReview('REJECTED')} variant="destructive">Discard</Button>
