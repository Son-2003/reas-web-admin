...
const dashboardSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchSuccessfulTransactions.fulfilled,
        (state, action: PayloadAction<number>) => {
      ...
      .addCase(
        fetchMonthlyRevenueBySubscriptionPlan.rejected,
        (state, action) => {
      ...
      .addCase(
        fetchSuccessfulExchanges.fulfilled,
        (state, action: PayloadAction<number>) => {
      ...
      .addCase(
        fetchCurrentActiveUsers.fulfilled,
        (state, action: PayloadAction<number>) => {
